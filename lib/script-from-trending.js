...
HARD CONSTRAINTS:
- 72-76 words total in the voiceover (slightly shorter — TTS rate dropped to +15% / ~140 wpm for clarity)
...
const STYLE_NOTES = (() => {
  const base = resolveStyleNotes();
  try { return base + '\n\n' + require('./ragnar-persona').buildPersonaPromptBlock(); }
  catch (_) { return base; }
})();
