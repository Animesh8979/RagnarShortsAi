...
const ROUTES = {
  script_llm:        ['nvidia-nemotron', 'groq-llama-3.3-70b', 'gemini-2.5-flash', 'github-models-gpt4o', 'cerebras', 'together-llama-3.3', 'openrouter-llama'],
  hero_image:        ['nvidia-flux.1-dev', 'nvidia-flux.2-klein', 'pollinations-seedream', 'hf-flux-schnell', 'gemini-image'],
  motion_video:      ['hf-wan-2.1', 'hf-ltx-video', 'fal-ltx', 'nvidia-cosmos'],
  ...
  fact_check:        ['gemini-2.5-flash', 'groq-llama-3.3-70b', 'nvidia-nemotron'],
  aesthetic_qa:      ['gemini-2.5-flash-vision'],
};
...
const KEY_REQUIREMENTS = {
  ...
  'gemini-2.5-flash-vision':   ['GEMINI_API_KEY'],
